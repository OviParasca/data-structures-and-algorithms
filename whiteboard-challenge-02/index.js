...
console.log(`remove middle element from array 1: ${myArray.removeShiftArray([1, 2, 3, 4, 5])}`);
console.log(`remove middle element from array 2: ${myArray.removeShiftArray([1, 2, 3, 4, 5, 6])}`);